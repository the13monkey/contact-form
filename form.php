    ...
    <form action="process.php" method="POST" id="contactform" enctype="multipart/form-data">
      ...
      <div class="row my-3">
        <div class="col-md my-3 my-md-2">
          ...
          <span class="text-secondary bg-light p-2 rounded">JPEG, JPG, GIF, PNG & PDF only</span>
      ...
      <div class="row my-3">
        <div class="col-md my-3 my-md-2">
          <div id="captcha" class="g-recaptcha" data-sitekey="6Ld0_8QUAAAAAJLKBOdfRlP-RbG5w6Cjkkt7uRJc"></div>
